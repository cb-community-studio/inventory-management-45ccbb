...
const UseraccountsCreateDialogComponent = (props) => {
    ...
    const onSave = async () => {
        ...
        setLoading(true);
        try {
            const result = await client.service("useraccounts").patch(_entity._id, _data);
            props.onHide();
    ...
    return (
        <Dialog header="Edit Info" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
            <div role="useraccounts-edit-dialog-component">
                <div>
                ...
                <div>
                    ...
                    <InputText type="number" className="w-full mb-3" value={_entity?.contact} onChange={(e) => setValByKey("contact", e.target.value)}  />
                </div>
...
export default connect(null, mapDispatch)(UseraccountsCreateDialogComponent);
