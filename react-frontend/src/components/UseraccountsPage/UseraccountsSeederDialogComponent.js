...
import seederData from "./useraccounts.seeder.json";
...
const UseraccountsSeederDialogComponent = (props) => {
...
export default connect(null, mapDispatch)(UseraccountsSeederDialogComponent);
