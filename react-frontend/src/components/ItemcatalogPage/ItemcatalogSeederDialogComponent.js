...
import seederData from "./itemcatalog.seeder.json";
...
const ItemcatalogSeederDialogComponent = (props) => {
...
export default connect(null, mapDispatch)(ItemcatalogSeederDialogComponent);
