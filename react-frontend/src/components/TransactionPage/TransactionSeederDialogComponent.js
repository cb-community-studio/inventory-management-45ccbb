...
import seederData from "./transaction.seeder.json";
...
const TransactionSeederDialogComponent = (props) => {
...
export default connect(null, mapDispatch)(TransactionSeederDialogComponent);
