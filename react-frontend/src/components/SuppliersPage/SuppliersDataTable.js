...
const SuppliersDataTable = ({ items, onEditRow, onRowDelete, onRowClick }) => {
    
    const pTemplate0 = (rowData, { rowIndex }) => <p >{rowData.name}</p>
    const inputTemplate1 = (rowData, { rowIndex }) => <InputText value={rowData.contact}  />
    ...
    return (
        <DataTable value={items} onRowClick={onRowClick} scrollable rowHover paginator rows={10}>
            ...
            <Column field="contact" header="Contact" body={inputTemplate1} style={{ minWidth: "8rem" }} />
